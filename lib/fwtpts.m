function [ Int, WTS, PTS, INTCLS ] = fwtpts( S, ORD, TYPE, f )
% 
...
%******OUTPUT PARAMETERS
%  WTS     Weight array size (1,INTCLS)
%  PTS     Point array size  (S,INTCLS)
%  INTCLS  Integer number of function values needed for the rule
